...
activities = {
    ...
    "Swimming Club": {
        "description": "Train in the pool and build endurance",
    ...
    "Drama Club": {
        "description": "Rehearse plays and develop performance skills",
    ...
    "Debate Team": {
        "description": "Practice rhetoric and compete in debate tournaments",
